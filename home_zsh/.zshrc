...
alias fastfetch="fastfetch --file ~/.neofetch-logo.txt"
...
⠠⢐⠠⠈⠄⠈⠄⠂⠨⠐⡐⠌⡪⢪⠨⠪⡨⢈⠄⢁⠀⢀⠀⢀⠀⠄⠁⢈⠀⢁⠈⡀⠐⠀⢁⠈⠀⠂⢈⠠"
    sleep .5
    printf "[19A\r%s" "⠄⢀⠐⠀⡈| [1;4;31mBAIT[0m OR [1;4;31mMENTAL RETARDATION[0m |⠐⠀⠂⠐⠀"
    sleep .5
    printf "[18B\r%s\n\n" "⠂⡁⡐⠄⠁⠌⠠⠈⠌⠄⡃⡇⡣⡑⡅| [1;4;31mCALL IT[0m |⠀⠂⠐⠀⠐⢀⠡⠀⠂⠀⠂⢐⠀⢂"
    sleep .5
    echo "[3mCoin says...[0m"
    sleep .5
    echo "✨ $([ $(shuf -i 0-1 -n 1) -eq 1 ] && echo Bait || echo Mental retardation) ✨"
}
function winehere {
    WINEPREFIX="$(pwd)" wine $@
}
